...
//     },
//   ];
//   const arr2 = arr.map((book) => ({
//     name: book.title,
//     authorName: book.author,
//   }));
//   // const membersArr2 = JSON.parse(membersArr).map((member) => {
//   //   const [firstName, lastName] = member.name.split(" ");
//   //   return { firstName, last,email:member.email,gender:"FEMALE", };
//   // });

//   const bodyJson = JSON.stringify(arr2);
//   console.log(bodyJson);

//   const memberResponse = await fetch(
//     "http://localhost:8080/api/members/populate",
//     {
//       method: "POST",
//       headers: {
...
//   const response = await fetch("http://localhost:8080/api/books/populate", {
//     method: "POST",
//     headers: {
//       Accept: "application/json",
//       "content-type": "application/json",
...
//                   entity.availability==="AVAILABLE" ? "bg-green-500" : "bg-red-500"
//                 } me-2`}
//               ></div>{" "}
//               {entity.availability}
//             </div>
...
//             >
//               {entity.availability==="AVAILABLE" ? "Borrow" : "Return"}
//             </button>
//             <button
//               onClick={(e) => {
//                 e.stopPropagation();
